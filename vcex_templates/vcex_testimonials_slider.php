						...
						$output .= '<div class="wpex-slider-slide sp-slide">';
							...
							$output .= '<div class="vcex-testimonials-fullslider-inner textcenter clr">';
								...
								// Full content
									...
									$output .= '<div class="entry remove-last-p-margin wpex-fw-300 clr"'. $slide_style .'>'. get_the_content() .'</div>';
									...
									$output .= '<div class="vcex-testimonials-fullslider-author wpex-fs-14px clr">';
										...
										if ( $atts['post_meta_company'] && 'true' == $display_author_company ) {
											if ( $atts['post_meta_url'] ) {
												...
												$output .= '<a href="'. esc_url( $atts['post_meta_url'] ) .'" class="vcex-testimonials-fullslider-company display-block" title="'. esc_attr( $atts['post_meta_company'] ) .'" target="_blank">'. $atts['post_meta_company'] .'</a>';

											} else {

												$output .= '<div class="vcex-testimonials-fullslider-company">'. $atts['post_meta_company'] .'</div>';
